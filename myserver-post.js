...
var MyServer = /** @class */ (function () {
			...
			return __generator(this, function (_a) {
				switch (_a.label) {
					case 0:
						return [
							4 /*yield*/,
							response.redirect("https://tet326.herokuapp.com"),
						];
					case 1:
						_a.sent();
						return [2 /*return*/];
	...
	MyServer.prototype.readallHandler = function (request, response) {
		return __awaiter(this, void 0, void 0, function () {
			return __generator(this, function (_a) {
				switch (_a.label) {
					case 0:
						return [4 /*yield*/, this.readallGames(request, response)];
					case 1:
						_a.sent();
						return [2 /*return*/];
				}
	...
	MyServer.prototype.readHandler = function (request, response) {
		return __awaiter(this, void 0, void 0, function () {
			return __generator(this, function (_a) {
				switch (_a.label) {
					case 0:
						return [4 /*yield*/, this.readGame(request.body.name, response)];
					case 1:
						_a.sent();
						return [2 /*return*/];
				}
	...
	MyServer.prototype.readUserHandler = function (request, response) {
		return __awaiter(this, void 0, void 0, function () {
			return __generator(this, function (_a) {
				switch (_a.label) {
					case 0:
						return [4 /*yield*/, this.readUser(request.body.name, response)];
					case 1:
						_a.sent();
						return [2 /*return*/];
				}
	...
	MyServer.prototype.deleteHandler = function (request, response) {
		return __awaiter(this, void 0, void 0, function () {
			return __generator(this, function (_a) {
				switch (_a.label) {
					case 0:
						return [4 /*yield*/, this.deleteUser(request.body.id, response)];
					case 1:
						_a.sent();
						return [2 /*return*/];
				}
			...
			return __generator(this, function (_a) {
				switch (_a.label) {
					case 0:
						...
						return [
							4 /*yield*/,
							this.games.add('{"name":"' + name + '","own":[],"want":[]}'),
						];
					case 1:
						_a.sent();
	...
	MyServer.prototype.readallGames = function (request, response) {
		return __awaiter(this, void 0, void 0, function () {
			...
			return __generator(this, function (_a) {
				switch (_a.label) {
					case 0:
						return [4 /*yield*/, this.games.getAll()];
					case 1:
						games = _a.sent();
			...
			return __generator(this, function (_b) {
				switch (_b.label) {
					case 0:
						...
						return [3 /*break*/, 4];
					case 1:
						return [4 /*yield*/, this.users.push(user, key, game)];
					case 2:
						_b.sent();
					...
					case 3:
						...
						return [3 /*break*/, 7];
					case 4:
						return [4 /*yield*/, this.users.pull(user, key, game)];
					case 5:
						_b.sent();
	...
	MyServer.prototype.createUser = function (
		name,
		email,
		password,
		img,
	...
	MyServer.prototype.updateUser = function (
		id,
		img,
		zip,
		add,
